...
client.query("select * from unnest(enum_range(null::BRAND))", function(err, rez){
    console.log(rez);
})
...
client.query("select * from unnest(enum_range(null::TIPURI_TELEFOANE))", function(err, rezCategorie){
    if (err){
        console.log(err);
    }
    else{
...
app.get("/produse", function(req, res){
    ...
    var conditieQuery="";
    if (req.query.tip){
        conditieQuery=`where TIP_TELEFON='${req.query.tip}'`
    }
    client.query("select * from unnest(enum_range(null::BRAND))", function(err, rezOptiuni){
