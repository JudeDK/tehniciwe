window.addEventListener("load",function() {
    ...
    document.getElementById("filtrare").onclick= function(){
        ...
        var Mem_a, Mem_b;
        if(val_Memorie!="toate")
        {
            [Mem_a, Mem_b]=val_Memorie.split(":");
            Mem_a=parseInt(Mem_a);
            Mem_b=parseInt(Mem_b);
        }

        let val_pret=document.getElementById("inp-pret").value;

        let val_Br=document.getElementById("inp-brand").value;
        ...
        for (let prod of produse){
            ...
            let Memorie=parseInt(prod.getElementsByClassName("val-memorie")[0].innerHTML);

            let cond2= (Memorie=="toate" || Mem_a<=Memorie && Memorie <Mem_b);
            ...
            let cond4= ( val_Br=="toate" ||  val_Br==Brand)
